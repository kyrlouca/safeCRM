    ...
    object Panel5: TPanel
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'LastName'#9'20'#9'LastName'
          'FirstName'#9'20'#9'FirstName'
  ...
  object InvoiceSQL: TIBCQuery
    SQLInsert.Strings = (
      'INSERT INTO INVOICE'
        ...
        'MER, AMOUNT_GROSS, AMOUNT_NET, AMOUNT_VAT, AMOUNT_WITH_VAT)'
      'VALUES'
    ...
    SQLRefresh.Strings = (
        ...
        'USTOMER, AMOUNT_GROSS, AMOUNT_NET, AMOUNT_VAT, AMOUNT_WITH_VAT F' +
        'ROM INVOICE'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLLock.Strings = (
    ...
    object InvoiceSQLLastName: TStringField
      DisplayWidth = 20
      FieldKind = fkLookup
      FieldName = 'LastName'
