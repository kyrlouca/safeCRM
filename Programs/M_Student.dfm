object M_StudentFRM: TM_StudentFRM
  Left = 365
  Top = 153
  Caption = '--'
  ClientHeight = 695
  ...
  object TableSQL: TIBCQuery
    ...
    SQL.Strings = (
      'SELECT'
        ...
        '    per.*, comp.serial_number as Company_serial,comp.last_name a' +
        's Company_name'
      'FROM'
      'Person per'
      '    left outer join'
      'person comp on per.fk_company_serial=comp.serial_number'
