...
type
  ...
  TR_Word_issonos1_frm = class(TForm)
    Panel1: TPanel;
    Panel3: TPanel;
    Panel4: TPanel;
    TableSQL: TIBCQuery;
...
var
  R_Word_issonos1_frm: TR_Word_issonos1_frm;
...
procedure TR_Word_issonos1_frm.BitBtn1Click(Sender: TObject);
begin
close;
end;

procedure TR_Word_issonos1_frm.BitBtn2Click(Sender: TObject);
begin
close;
...
procedure TR_Word_issonos1_frm.ppReport1PreviewFormCreate(
  Sender: TObject);
begin
...
procedure TR_Word_issonos1_frm.ppVariable1Calc(Sender: TObject; var Value: Variant);
begin
// value:=vt.FieldByName('DaysCalc').AsInteger;
end;

procedure TR_Word_issonos1_frm.ppVariable2Calc(Sender: TObject; var Value: Variant);
begin
// value:=vt.FieldByName('ActionDate').AsDateTime;

end;

procedure TR_Word_issonos1_frm.ppVariable3Calc(Sender: TObject; var Value: Variant);
begin
   value:=FromDateFLD.Date
end;

procedure TR_Word_issonos1_frm.RzBitBtn1Click(Sender: TObject);
begin
  close;
end;
...
procedure TR_Word_issonos1_frm.TableSQLCalcFields(DataSet: TDataSet);
var
  days:integer;
begin
...
Function TR_Word_issonos1_frm.CalcDaysLeft():TReminderResult;
begin
...
Function TR_Word_issonos1_frm.FindActionDate(const DateSeminar:TDate;Const isAfter,isDayUnit:Boolean;Const NumberOfUnits:Integer):Tdate;
var
  mySign:Integer;
  DateReminder:TDate;
begin
...
procedure TR_Word_issonos1_frm.PrintRBtnClick(Sender: TObject);
begin
...
Procedure TR_Word_issonos1_frm.PrintTheSeminar();
...
procedure TR_Word_issonos1_frm.FormCreate(Sender: TObject);
begin
  cn:=U_databaseFRM.DataConnection;
end;

procedure TR_Word_issonos1_frm.DisplayFilter;
var
