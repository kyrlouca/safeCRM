...
procedure TS_loadPdfFRM.RzBitBtn1Click(Sender: TObject);
begin
close;
end;

procedure TS_loadPdfFRM.WriteStreamToDatabase(Const CodeKey:String;Const FileName :String; Const MonoPOly:String);
var
//  BlobField: TField;
...
procedure TS_loadPdfFRM.wwButton1Click(Sender: TObject);
VAR
  fileName:String;
begin
...
procedure TS_loadPdfFRM.CopyaFile(Const DocSerial:Integer;Const FileName :String);
var
//  BlobField: TField;
  BlobField: TBlobField;
  BS: TStream;
...
procedure TS_loadPdfFRM.SaveToFileXX(Const CodeKey:String;Const FileName :String; Const MonoPOly:String);
var
  BlobField: TBlobField;
  BS: TStream;
  str2:String;
...
procedure TS_loadPdfFRM.SaveXX(Const SerialNumber:Integer;Const  FilePath, DocName :String);
var
  BlobField: TBlobField;
//  BS: TStream;
  str2:String;
...
procedure TS_loadPdfFRM.TableSQLNewRecord(DataSet: TDataSet);
begin
...
procedure TS_loadPdfFRM.Nav1InsertClick(Sender: TObject);
var
  FileName:String;
  FIlePath:String;
  codeKey:String;
...
procedure TS_loadPdfFRM.CopyModifiedFile(Const DocSerial:Integer;Const FileName :String);
var
//  BlobField: TField;
  BlobField: TBlobField;
  BS: TStream;
