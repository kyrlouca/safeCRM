object P_ViewPaymentFRM: TP_ViewPaymentFRM
  Left = 365
  Top = 153
  Caption = '--'
  ClientHeight = 558
    ...
    object RzPanel2: TRzPanel
      ...
      object Grid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'PAYMENT_METHOD'#9'7'#9#932#961#972#960#959#962' '#9#9
          'CHEQUE_NUMBER'#9'18'#9#913#961'. '#917#960#953#964#945#947#942#962#9#9
          'DATE_PAYMENT'#9'16'#9#919#956#949#961'. '#928#955#951#961#969#956#942#962#9#9
          'AMOUNT_PAID'#9'14'#9#928#959#963#972#9#9)
  ...
  object InvoiceSQL: TIBCQuery
    ...
    SQL.Strings = (
      ...
      'where inv.serial_number= :SerialNumber')
    ...
    object InvoiceSQLPERSON_NATIONAL_ID: TWideStringField
  ...
  object PaymentSql: TIBCQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO INVOICE_PAYMENT'
        ...
        ', DATE_PAYMENT, CHEQUE_NUMBER)'
      'VALUES'
      
        '  (:SERIAL_NUMBER, :FK_INVOICE_SERIAL, :AMOUNT_PAID, :PAYMENT_ME' +
        'THOD, :DATE_PAYMENT, :CHEQUE_NUMBER)')
    SQLDelete.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'THOD, DATE_PAYMENT, CHEQUE_NUMBER FROM INVOICE_PAYMENT'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
    ...
    object PaymentSqlPAYMENT_METHOD: TWideStringField
      DisplayLabel = #932#961#972#960#959#962' '
      DisplayWidth = 7
    ...
    object PaymentSqlCHEQUE_NUMBER: TWideStringField
      DisplayLabel = #913#961'. '#917#960#953#964#945#947#942#962
      DisplayWidth = 18
    ...
    object PaymentSqlDATE_PAYMENT: TDateField
      DisplayLabel = #919#956#949#961'. '#928#955#951#961#969#956#942#962
      DisplayWidth = 16
