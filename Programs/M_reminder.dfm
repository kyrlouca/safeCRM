  ...
  object Panel3: TPanel
    ...
    object GroupBox2: TGroupBox
      ...
      object Label21: TLabel
        ...
        Width = 81
        Height = 14
        Caption = #919#956#949#961'. '#904#957#945#961#958#951#962
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        Font.Name = 'Tahoma'
      ...
      object wwDBDateTimePicker5: TwwDBDateTimePicker
        ...
        CalendarAttributes.Font.Style = []
        Color = clBtnFace
        DataField = 'SEMINAR_DATE_STARTED'
        DataSource = CompanySRC
        Epoch = 1950
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
  ...
  object CompanySQL: TIBCQuery
    ...
    SQL.Strings = (
      'Select'
        ...
        'Date_started as Seminar_date_started'
      'from'
      'seminar_reminder sr'
    ...
    object CompanySQLAFTER_OR_BEFORE: TWideStringField
      FieldName = 'AFTER_OR_BEFORE'
      FixedChar = True
      Size = 1
    end
    object CompanySQLPERSON_OR_SEMINAR: TWideStringField
      FieldName = 'PERSON_OR_SEMINAR'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CompanySQLSTART_OR_END: TWideStringField
      FieldName = 'START_OR_END'
      FixedChar = True
      Size = 1
    end
    object CompanySQLDAYS_OR_MONTHS: TWideStringField
      FieldName = 'DAYS_OR_MONTHS'
      FixedChar = True
      Size = 1
    end
    object CompanySQLNUMBER_OF_DAYS_MONTHS: TIntegerField
      FieldName = 'NUMBER_OF_DAYS_MONTHS'
    end
    object CompanySQLREMINDER_TYPE: TWideStringField
      FieldName = 'REMINDER_TYPE'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CompanySQLIS_COMPLETED: TWideStringField
    ...
    object CompanySQLSEMINAR_SERIAL: TIntegerField
